    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 selection:bg-blue-100">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-headline font-extrabold text-slate-900 tracking-tight">Welcome back</h1>
          <p className="text-slate-500 mt-2 font-medium">Continue your journey in the sanctuary.</p>
        </div>
